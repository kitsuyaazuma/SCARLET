...
from scarlet.core import FilteredDataset, PartitionedDataset


def test_partitioned_dataset_implementation() -> None:
    ...
    class DummyPartitionedDataset(PartitionedDataset):
        ...
        def set_dataset(self, type_: str, cid: int | None, dataset: Dataset) -> None:
            _ = (type_, cid, dataset)
            return
